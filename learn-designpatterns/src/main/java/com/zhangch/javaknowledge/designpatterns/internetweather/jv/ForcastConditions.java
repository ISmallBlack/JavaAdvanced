package com.zhangch.javaknowledge.designpatterns.internetweather.jv;

import java.util.Observable;
import java.util.Observer;

import com.zhangch.javaknowledge.designpatterns.internetweather.jv.WeatherData.Data;
