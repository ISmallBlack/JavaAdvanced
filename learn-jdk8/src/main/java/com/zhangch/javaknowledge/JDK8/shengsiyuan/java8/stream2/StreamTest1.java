...
public class StreamTest1 {
    ...
    public static void main(String[] args) {
        ...
        Student student2 = new Student("lisi", "2",90);
        Student student3 = new Student("wangwu", "3",100);
        Student student4 = new Student("zhaoliu", "4",90);
        Student student5 = new Student("zhaoliu", "5",90);
        ...
        Map<String, Student> map6 = students.stream().
                collect(groupingBy(Student::getUrid, collectingAndThen(reducing((a,b) -> a),
                        Optional::get)));
