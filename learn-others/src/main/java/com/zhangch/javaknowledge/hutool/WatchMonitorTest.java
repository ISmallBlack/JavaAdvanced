package com.zhangch.javaknowledge.hutool;
...
public class WatchMonitorTest {
	...
	public static void main(String[] args) {
		...
		final LineReadWatcher lineReadWatcher = new LineReadWatcher(randomAccessFile, CharsetUtil.CHARSET_UTF_8, Tailer.CONSOLE_HANDLER);
